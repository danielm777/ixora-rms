...
import com.ixora.rms.ui.dataviewboard.DataViewControl.Callback;
...
public final class DataViewBoardHandler extends Observable
	...
	private final class EventHandler implements DataViewBoard.Listener, DataViewControl.Callback {
		...
		/**
		 * @see com.ixora.rms.ui.dataviewboard.DataViewControl.Callback#move(com.ixora.rms.ui.dataviewboard.DataViewControl, java.lang.String, java.lang.String)
		 */
    ...
    public DataViewBoardHandler(
		...
		this.fScreens.put(DEFAULT_SCREEN, new DataViewScreen(DEFAULT_SCREEN));
     ...
     * @param viewBoard
     */
    private void handleMoveControl(DataViewControl control, String screen,
			String viewBoard) {
		try {
			if(Utils.isEmptyString(screen)) {
				screen = fCurrentScreen;
			}
			DataViewScreen dvscreen = fScreens.get(screen);
			if(dvscreen != null) {
				DataViewBoard receivingViewBoard = dvscreen.getBoard(viewBoard);
	...
	/**
	 * @see com.ixora.rms.ui.dataviewboard.DataViewPlotter#plot(com.ixora.rms.internal.ResourceId, com.ixora.rms.repository.DataView)
	 */
    ...
    public void initializeFromScreenDescriptors(Collection<DataViewScreenDescriptor> descs) throws SecurityException, IllegalArgumentException, NoSuchMethodException, ClassNotFoundException, InstantiationException, IllegalAccessException, InvocationTargetException {
    	...
    	for(DataViewScreenDescriptor desc : descs) {
    		...
    		DataViewScreen screen = new DataViewScreen(desc.getScreenName());
	...
	public void addNewScreen() throws ScreenNameAlreadyExists {
    	...
    	fScreens.put(screenName, new DataViewScreen(screenName));
	...
	public void removeScreen() {
		...
		if(before >= 0) {
			...
			if(after < size) {
				...
				fScreens.put(DEFAULT_SCREEN, new DataViewScreen(DEFAULT_SCREEN));
...
//		ResourceId context = view.getContext();
	...
	/**
	 * @see com.ixora.rms.ui.dataviewboard.DataViewControlContext#getReactionLogService()
	 */
	public ReactionLogService getReactionLogService() {
		return this.fReactionLog;
	}

	/**
	 * @see com.ixora.rms.ui.dataviewboard.DataViewControlContext#getSessionArtefactLocator()
	 */
	public SessionArtefactInfoLocator getSessionArtefactLocator() {
		return fPlottedInfoLocator;
	}
	...
	/**
	 * @see com.ixora.rms.ui.dataviewboard.DataViewControlContext#getAvailableDataViewBoards(com.ixora.rms.ui.dataviewboard.DataViewControl)
	 */
	public Map<String, List<DataViewBoard>> getAvailableDataViewBoards(
			DataViewControl control) {
		Map<String, List<DataViewBoard>> ret = new HashMap<String, List<DataViewBoard>>();
		for(DataViewScreen screen : fScreens.values()) {
			List<DataViewBoard> lst = screen.getAvailableDataViewBoards(control);
			if(!Utils.isEmptyCollection(lst)) {
				ret.put(screen.getName(), lst);
			}
		}
		return ret;
	}
