...
set WAS_CP=C:\Dev\workspace\RMSTestsTmp
...
set WAS_CP=%WAS_CP%;%WAS_HOME%\lib\namingclient.jar
%WAS_HOME%\java\bin\java.exe "%CLIENTSOAP%" "%CLIENTSAS%" "-Dws.ext.dirs=%WAS_EXT_DIRS%" %DEBUGOPTS% -classpath "%WAS_CP%" com.ixora.was.TestPC