...
/**
 * JMXConnection that delegates to an MBeanServerConnection.
 * @author Daniel Moraru
 */
public class JMXConnectionMBeanServerConnection implements JMXConnection {
	private MBeanServerConnection fServer;

	/**
	 * @param server
	 */
	public JMXConnectionMBeanServerConnection(MBeanServerConnection server) {
		fServer = server;
	}
	/**
