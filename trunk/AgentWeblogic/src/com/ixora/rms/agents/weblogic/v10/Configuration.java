...
/**
 * Configuration for Weblogic 10.3 agent.
 * @author Daniel Moraru
 */
public class Configuration extends ConfigurationWithClasspath {
	private static final long serialVersionUID = 8530564962055993561L;
	...
	public Configuration() {
        ...
        setString(ROOT_FOLDER, "C:/bea/wlserver_10.3");
		setString(CLASSPATH, "/server/lib/wlfullclient.jar");
	}
}