 ...
 *                   Eduardo Ramalho;
 *
 * $Id: XYPlot.java,v 1.26 2005/03/10 11:23:17 mungady Exp $
 *
 ...
 *
 */
// Some changes made for IxoraRMS
...
public class XYPlot extends Plot implements ValueAxisPlot,
                                            ...
                                            Serializable {
//  BEGIN ixora MOD
    private static final Stroke STROKE_RANGE_GRID_1 = new BasicStroke(
            1.3f,
            BasicStroke.CAP_BUTT,
            BasicStroke.JOIN_BEVEL,
            0.0f,
            null, //new float[] {3.0f, 3.0f},
            0.0f
        );
    private static final Stroke STROKE_RANGE_GRID_2 = new BasicStroke(
            0.7f,
            BasicStroke.CAP_BUTT,
            BasicStroke.JOIN_BEVEL,
            0.0f,
...
// END ixora MOD
    ...
    private boolean zeroRangeBaselineVisible;

    private transient Stroke zeroRangeBaselineStroke;

    private transient Paint zeroRangeBaselinePaint;
    ...
    public XYPlot(XYDataset dataset,
        ...
        this.zeroRangeBaselineVisible = false;
        this.zeroRangeBaselinePaint = Color.black;
        this.zeroRangeBaselineStroke = new BasicStroke(0.5f);
    ...
    public boolean isZeroRangeBaselineVisible() {
        return this.zeroRangeBaselineVisible;
    }
    ...
    public void setZeroRangeBaselineVisible(boolean visible) {
        this.zeroRangeBaselineVisible = visible;
        notifyListeners(new PlotChangeEvent(this));
    }
     ...
     * @return The stroke (never <code>null</code>).
     */
    public Stroke getZeroRangeBaselineStroke() {
        return this.zeroRangeBaselineStroke;
    }
     ...
     * @param stroke  the stroke (<code>null</code> not permitted).
     */
    public void setZeroRangeBaselineStroke(Stroke stroke) {
        if (stroke == null) {
            throw new IllegalArgumentException("Null 'stroke' argument.");
        }
        this.zeroRangeBaselineStroke = stroke;
        notifyListeners(new PlotChangeEvent(this));
    }
     ...
     * @return The paint (never <code>null</code>).
     */
    public Paint getZeroRangeBaselinePaint() {
        return this.zeroRangeBaselinePaint;
    }
     ...
     * @param paint  the paint (<code>null</code> permitted).
     */
    public void setZeroRangeBaselinePaint(Paint paint) {
        this.zeroRangeBaselinePaint = paint;
        notifyListeners(new PlotChangeEvent(this));
    }
    ...
    */
     ...
     * printer).
     * <P>
     * This plot relies on an {@link XYItemRenderer} to draw each item in the
     ...
     * @param state  collects chart drawing information (<code>null</code>
     *               permitted).
     */
    ...
    public void draw(Graphics2D g2,
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug(
                "Entering draw() method, plot area = " + area.toString()
            );
        }
        ...
        // draw the general markers (assigned to renderer 0 by default)
            ...
            if (axis != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (tick.getValue() != 0.0
                            || !this.isZeroRangeBaselineVisible()) {
                        Stroke stroke;
                        if(i % 2 == 0) {
                            stroke = STROKE_RANGE_GRID_1;
                        } else {
                            stroke = STROKE_RANGE_GRID_2;
                        }
                        getRenderer().drawRangeLine(
                            g2, this, getRangeAxis(), dataArea,
                            tick.getValue(), gridPaint, stroke);
                        ++i;
                    }
                }
            }
...
*/
    ...
    protected void drawZeroRangeBaseline(Graphics2D g2, Rectangle2D dataArea) {
        ...
        if (isZeroRangeBaselineVisible()) {
            getRenderer().drawRangeLine(
                g2, this, getRangeAxis(), dataArea,
                0.0, this.zeroRangeBaselinePaint, this.zeroRangeBaselineStroke
            );
        }
    ...
    /**
     * Draws the domain markers (if any) for the specified layer.  This method
    ...
    /**
     * Draws the range markers (if any) for the specified layer.  This method
     * is typically called from within the draw() method.
     *
     * @param g2  the graphics device.
     * @param dataArea  the data area.
    ...
    public boolean equals(Object obj) {
        ...
        if (this.zeroRangeBaselineVisible != that.zeroRangeBaselineVisible) {
            return false;
        }
        ...
        if (!ObjectUtilities.equal(
                this.zeroRangeBaselinePaint, that.zeroRangeBaselinePaint
            )) {
            return false;
        }
        if (!ObjectUtilities.equal(
                this.zeroRangeBaselineStroke, that.zeroRangeBaselineStroke
            )) {
            return false;
        }
        if (!ObjectUtilities.equal(
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
        ...
        SerialUtilities.writeStroke(this.zeroRangeBaselineStroke, stream);
        SerialUtilities.writePaint(this.zeroRangeBaselinePaint, stream);
    ...
    private void readObject(ObjectInputStream stream)
        ...
        this.zeroRangeBaselineStroke = SerialUtilities.readStroke(stream);
        this.zeroRangeBaselinePaint = SerialUtilities.readPaint(stream);
