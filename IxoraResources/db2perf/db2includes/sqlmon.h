...
#define SQLM_HEAP_MAX           SQLM_HEAP_BP
...
#define SQLM_LOCKATTR_DELETE_IN_BLOCK 0x00000008  /* deleted row "in" block   */
...
#define SQLM_INTERNALP_LOCK     8        /* Internal lock   (for internal use)*/
#define SQLM_INTERNALV_LOCK     9        /* Internal lock   (for internal use)*/
#define SQLM_INTERNALS_LOCK     10       /* Internal lock   (for internal use)*/
#define SQLM_INTERNALJ_LOCK     11       /* Bufferpool lock                   */
#define SQLM_INTERNALL_LOCK     12       /* Internal lock   (for internal use)*/
#define SQLM_INTERNALC_LOCK     13       /* Internal lock   (for internal use)*/
#define SQLM_INTERNALB_LOCK     14       /* Internal lock   (for internal use)*/
#define SQLM_INTERNALO_LOCK     15       /* Internal lock   (for internal use)*/
#define SQLM_INTERNALT_LOCK     16       /* Internal lock   (for internal use)*/
#define SQLM_INTERNALQ_LOCK     17       /* Internal lock   (for internal use)*/
...
#define SQLM_EVENT_MAX             16  /* Must be set to the largest value in */
                                       /* the list                            */
...
#define SQLM_MAX_LOGICAL_ELEMENT 48 /* This value should equal the largest of */
...
#define SQLM_ELM_AGENT_ID         302 /* used for requests based on           */
                                      /* appl-handle                          */
#define SQLM_ELM_SERVER_DB2_TYPE  303 /* Server DB2 Type (defined in          */
                                      /* sqlutil.h)                           */
...
#define SQLM_ELM_TOTAL_SEC_CONS      497 /* Secondary connects                */
                                         /* database connection.              */
...
#define SQLM_ELM_POOL_MAX_SIZE       688  /* Largest size pool can have       */
