...
/******************************************************************************
** Fetch Next History Entry Definititions
*******************************************************************************/
...
/******************************************************************************
** Close History Scan Definititions
*******************************************************************************/
...
/******************************************************************************
** Update History Entry Definititions
*******************************************************************************/
...
/******************************************************************************
** Prune Database History Definititions
*******************************************************************************/
...
{
  char                        *piDatabaseAlias; /* Alias of database to       */
                                            /* archive log for                */
  char                        *piUserName;  /* User name to execute command   */
                                            /* under                          */
  char                        *piPassword;  /* Password for username          */
  db2Uint16                   iAllNodeFlag; /* Flag indicating how the        */
                                            /* iNodeList should be used       */
  db2Uint16                   iNumNodes;    /* Number of nodes in piNodeList  */
                                            /* array                          */
  SQL_PDB_NODE_TYPE           *piNodeList;  /* Node list                      */
...
{
  db2Uint32                   iAliasLen;    /* Length of database alias       */
                                            /* field                          */
  db2Uint32                   iUserNameLen; /* Length of username field       */
  db2Uint32                   iPasswordLen; /* Length of password field       */
  char                        *piDatabaseAlias; /* Alias of database to       */
                                            /* archive log for                */
  char                        *piUserName;  /* User name to execute command   */
                                            /* under                          */
...
typedef SQL_STRUCTURE db2ReadLogInfoStruct
{
  ...
  SQLU_LSN                    nextStartLSN; /* Next LSN caller should read    */
  db2Uint32                   logRecsWritten; /* Number of log records        */
                                            /* returned                       */
  db2Uint32                   logBytesWritten; /* Number of log bytes         */
                                            /* returned                       */
  SQLU_LSN                    firstReusedLSN; /* First LSN reused due to      */
                                            /* restore/rollforward            */
  db2Uint32                   timeOfLSNReuse; /* Timestamp for when LSN       */
                                            /* reuse occurred                 */
...
{
  db2Uint32                   iCallerAction; /* Type of read required         */
  SQLU_LSN                    *piStartLSN;  /* Start read log sequence        */
                                            /* number                         */
  SQLU_LSN                    *piEndLSN;    /* End read log sequence number   */
  char                        *poLogBuffer; /* User buffer                    */
  db2Uint32                   iLogBufferSize; /* Size of user buffer          */
  db2Uint32                   iFilterOption; /* Set filtering level           */
  db2ReadLogInfoStruct        *poReadLogInfo; /* Read log information         */
                                            /* structure                      */
} db2ReadLogStruct;
...
{
  db2Uint32                   iFilterOption; /* Set filtering level           */
  char                        *piLogFilePath; /* Path to log files to be      */
                                            /* read                           */
  char                        *piOverflowLogPath; /* Secondary path to log    */
                                            /* files                          */
  db2Uint32                   iRetrieveLogs; /* Retrieve logs options         */
  char                        *piDatabaseName; /* Name of the source          */
                                            /* database                       */
  char                        *piNodeName;  /* Name of the source node        */
  db2Uint32                   iReadLogMemoryLimit; /* Number of bytes of      */
                                            /* memory the API may allocate    */
                                            /* internally                     */
  char                        **poReadLogMemPtr; /* Pointer to API allocate   */
                                            /* memory                         */
...
{
  SQLU_LSN                    firstAvailableLSN; /* First available LSN in    */
                                            /* logpath                        */
  SQLU_LSN                    firstReadLSN; /* First LSN read on call         */
  SQLU_LSN                    nextStartLSN; /* Next LSN caller should read    */
  db2Uint32                   logRecsWritten; /* Number of log records        */
...
typedef SQL_STRUCTURE db2ReadLogNoConnStruct
{
  ...
  char                        *poLogBuffer; /* User buffer                    */
  db2Uint32                   iLogBufferSize; /* Size of user buffer          */
  char                        *piReadLogMemPtr; /* Pointer to API allocated   */
                                            /* memory                         */
  db2ReadLogNoConnInfoStruct  *poReadLogInfo; /* Read log information         */
                                            /* structure                      */
...
{
  char                        **poReadLogMemPtr; /* Pointer to API allocated  */
                                            /* memory                         */
...
{
  char                        iDbAlias[SQL_ALIAS_SZ + 1]; /* Input: Database  */
                                            /* alias - reserved               */
  db2Uint16                   iNumIterations; /* Input: Number of iterations  */
  db2Uint32                   *poElapsedTime; /* Output: Array of elapsed     */
                                            /* times (microsec), contains     */
...
{
  db2Uint16                   iDbAliasLength; /* Input: Db alias name length  */
                                            /* - reserved                     */
  char                        iDbAlias[SQL_ALIAS_SZ + 1]; /* Input: Database  */
                                            /* alias - reserved               */
  db2Uint16                   iNumIterations; /* Input: Number of iterations  */
...
{
  struct sqlma                *piSqlmaData; /* Pointer to monitor area        */
  struct sqlm_collected       *poCollectedData; /* Pointer to collected data  */
  ...
  db2Uint32                   *poOutputFormat; /* Pointer to output format    */
                                            /* indicator                      */
  db2Uint32                   iSnapshotClass; /* Class qualifier for          */
                                            /* snapshot                       */
} db2GetSnapshotData;
...
{
  struct sqlma                *piSqlmaData; /* Pointer to monitor area        */
  sqluint32                   *poBufferSize; /* Pointer to output buffer      */
  db2Uint32                   iVersion;     /* Snapshot version               */
  db2int32                    iNodeNumber;  /* Target node                    */
  db2Uint32                   iSnapshotClass; /* Class qualifier for          */
                                            /* snapshot                       */
...
{
  struct sqlm_recording_group *piGroupStates; /* Pointer to group states      */
  void                        *poBuffer;    /* Pointer to output buffer       */
  db2Uint32                   iBufferSize;  /* Size of output buffer          */
...
{
  char                        *piDatabaseName; /* Database name or alias      */
  char                        *piUserId;    /* User Id                        */
  char                        *piPassword;  /* Password                       */
  char                        *piTablespaceNames; /* Droppending tablespace   */
                                            /* name list                      */
...
{
  db2Uint32                   iDatabaseNameLen; /* Length in bytes of         */
                                            /* piDatabaseName                 */
  db2Uint32                   iUserIdLen;   /* Length in bytes of piUserId    */
  db2Uint32                   iPasswordLen; /* Length in bytes of piPassword  */
  db2Uint32                   iTablespaceNamesLen; /* Length in bytes of      */
                                            /* piTablespaceNames              */
  char                        *piDatabaseName; /* Database name or alias      */
  char                        *piUserId;    /* User Id                        */
  char                        *piPassword;  /* Password                       */
  char                        *piTablespaceNames; /* Tablespace name list     */
} db2gRestartDbStruct;
...
typedef struct db2AdminMsgWriteStruct
{
  ...
  char                        *piData_title; /* Title describing data         */
  void                        *piData;      /* Data                           */
...
{
  db2int32                    iOption;      /* Suspend or resume              */
  char                        *piTablespaceNames; /* Suspending tablespace    */
                                            /* name list: empty for all       */
                                            /* Tablespaces                    */
} db2SetWriteDbStruct;

SQL_API_RC SQL_API_FN                       /* Set Write Suspend/Resume For   */
                                            /* DB                             */
  db2SetWriteForDB (
  db2Uint32 versionNumber,                  /* Database version number        */
  void * pParmStruct,                       /* In/out parameters              */
...
{
  char                        *piTablespaceName; /* Tablespace name; null     */
                                            /* terminated                     */
  char                        *piTableName; /* Table name; null terminated    */
  char                        *piSchemaName; /* Schema name; null terminated  */
  char                        *piResultsName; /* Results Output file name;    */
                                            /* null terminated                */
  char                        *piDataFileName; /* Data file name; null        */
                                            /* terminated                     */
  SQL_PDB_NODE_TYPE           *piNodeList;  /* Array of nodes                 */
  db2Uint32                   iAction;      /* Action                         */
  db2int32                    iTablespaceID; /* Tablespace ID                 */
  db2int32                    iObjectID;    /* Object ID                      */
  db2Uint32                   iFirstPage;   /* Page number of first page      */
  db2Uint32                   iNumberOfPages; /* Number of pages              */
  db2Uint32                   iFormatType;  /* Format type                    */
  db2Uint32                   iOptions;     /* Options                        */
  db2Uint32                   iBeginCheckOption; /* Begin checking option     */
  db2int32                    iLimitErrorReported; /* Number of pages in      */
                                            /* error in object to limit       */
                                            /* reporting of                   */
  db2Uint16                   iObjectErrorState; /* Object error state        */
                                            /* option                         */
  db2Uint16                   iCatalogToTablespace; /* Catalog to tablespace  */
                                            /* consistency option             */
  db2Uint16                   iKeepResultfile; /* Keep result file            */
  db2Uint16                   iAllNodeFlag; /* all node flag                  */
  db2Uint16                   iNumNodes;    /* Number of nodes                */
  db2Uint16                   iLevelObjectData; /* Processing level for Data  */
                                            /* object                         */
  db2Uint16                   iLevelObjectIndex; /* Processing level for      */
                                            /* Index object                   */
  db2Uint16                   iLevelObjectLong; /* Processing level for Long  */
                                            /* object                         */
  db2Uint16                   iLevelObjectLOB; /* Processing level for LOB    */
                                            /* object                         */
  db2Uint16                   iLevelObjectBlkMap; /* Processing level for     */
                                            /* Block map object               */
  db2Uint16                   iLevelExtentMap; /* Processing level for        */
                                            /* Extent map                     */
} db2InspectStruct;
...
typedef SQL_STRUCTURE db2gInspectStruct
{
  ...
  SQL_PDB_NODE_TYPE           *piNodeList;  /* Array of nodes                 */
  db2Uint32                   iResultsNameLength; /* Results Output file      */
                                            /* name length                    */
  db2Uint32                   iDataFileNameLength; /* Data file name length   */
  db2Uint32                   iTablespaceNameLength; /* Tablespace name       */
                                            /* length                         */
  db2Uint32                   iTableNameLength; /* Table name length          */
  db2Uint32                   iSchemaNameLength; /* Schema name length        */
  db2Uint32                   iAction;      /* Action                         */
  db2int32                    iTablespaceID; /* Tablespace ID                 */
  db2int32                    iObjectID;    /* Object ID                      */
  db2Uint32                   iFirstPage;   /* Page number of first page      */
...
#define DB2INSPECT_ACT_CHECK_RESTART (DB2INSPECT_ACTION_CHECK+1) /* Inspect   */
                                            /* check restart                  */
#define DB2INSPECT_ACT_CHECK_DB (DB2INSPECT_ACTION_CHECK+2) /* Inspect DB     */
#define DB2INSPECT_ACT_CHECK_TABSPACE (DB2INSPECT_ACTION_CHECK+3) /* Inspect  */
                                            /* tablespace                     */
#define DB2INSPECT_ACT_CHECK_TABLE (DB2INSPECT_ACTION_CHECK+4) /* Inspect     */
                                            /* table                          */
#define DB2INSPECT_ACT_CHECK_DATA (DB2INSPECT_ACTION_CHECK+5) /* Inspect      */
                                            /* data object                    */
#define DB2INSPECT_ACT_CHECK_INDEX (DB2INSPECT_ACTION_CHECK+6) /* Inspect     */
                                            /* index object                   */
#define DB2INSPECT_ACT_CHECK_BLOCKMAP (DB2INSPECT_ACTION_CHECK+7) /* Inspect  */
                                            /* block map object               */
#define DB2INSPECT_ACT_CHECK_08 (DB2INSPECT_ACTION_CHECK+8) /* Reserved       */
#define DB2INSPECT_ACT_CHECK_09 (DB2INSPECT_ACTION_CHECK+9) /* Reserved       */
#define DB2INSPECT_ACT_CHECK_10 (DB2INSPECT_ACTION_CHECK+10) /* Reserved      */
#define DB2INSPECT_ACT_FORMAT_PAGE (DB2INSPECT_ACTION_FORMAT+1) /* Format     */
                                            /* page in tablespace             */
#define DB2INSPECT_ACT_FORMAT_EXT_MAP (DB2INSPECT_ACTION_FORMAT+2) /* Format  */
                                            /* extent map                     */
#define DB2INSPECT_ACT_FORMAT_DATA (DB2INSPECT_ACTION_FORMAT+3) /* Format     */
                                            /* data page                      */
#define DB2INSPECT_ACT_FORMAT_INDEX (DB2INSPECT_ACTION_FORMAT+4) /* Format    */
                                            /* index page                     */
#define DB2INSPECT_ACT_FORMAT_BLOCKMAP (DB2INSPECT_ACTION_FORMAT+5) 
#define DB2INSPECT_ACT_FORMAT_06 (DB2INSPECT_ACTION_FORMAT+6) /* Reserved     */
#define DB2INSPECT_ACT_FORMAT_07 (DB2INSPECT_ACTION_FORMAT+7) /* Reserved     */
#define DB2INSPECT_ACT_FORMAT_08 (DB2INSPECT_ACTION_FORMAT+8) /* Reserved     */
#define DB2INSPECT_ACT_FORMAT_09 (DB2INSPECT_ACTION_FORMAT+9) /* Reserved     */
#define DB2INSPECT_ACT_FORMAT_10 (DB2INSPECT_ACTION_FORMAT+10) /* Reserved    */
...
#define DB2INSPECT_BEGIN_TSPID 0x1          /* Begin check on tablespace ID.  */
#define DB2INSPECT_BEGIN_OBJID 0x2          /* Begin check on object ID.      */
...
#define DB2INSPECT_LIMIT_ERROR_DEFAULT 0    /* limit errors reported to       */
                                            /* default number                 */
#define DB2INSPECT_LIMIT_ERROR_ALL -1       /* no limit to errors reported    */

/* Values for db2Inspect - iObjectErrorState                                  */
#define DB2INSPECT_ERROR_STATE_NORMAL 0     /* process object only in normal  */
                                            /* state                          */
#define DB2INSPECT_ERROR_STATE_ALL 1        /* process object in any state    */
...
#define DB2INSPECT_RESFILE_CLEANUP 0        /* Clean up result file when no   */
                                            /* error                          */
...
/* Priority structure                                                         */
typedef SQL_STRUCTURE db2PriorityStruct
{
  db2Uint32                   iFlag;        /* control flag                   */
  db2Uint32                   iAgentId;     /* agent id                       */
  db2Uint32                   ioPriorityLevel; /* priority level              */
  db2Uint16                   iPriorityType; /* priority type                 */
} db2PriorityStruct;

/* Values for db2PriorityStruct - iFlag                                       */
#define DB2PRIORITY_SET_APP   1             /* Set the application priority   */
#define DB2PRIORITY_SET_DB2   2             /* Set DB2 internal priority      */
#define DB2PRIORITY_GET_DB2   3             /* Query DB2 internal priority    */

/* Priority API                                                               */
SQL_API_RC SQL_API_FN                       /* Set/Query Priority             */
  db2Priority (
