...
#define SQLM_PLATFORM_LINUXAMD64     30         /* Linux for AMD x86-64       */
...
#define SQLM_EVENT_MAX             18  /* Must be set to the largest value in */
                                       /* the list                            */
...
#define SQLM_MAX_LOGICAL_ELEMENT 49 /* This value should equal the largest of
...
#define SQLM_ELM_SQL_CHAINS          778 /* # of SQL stmt chains sent         */
